...
I think I deserve a C in this class because I have achieved the learning objectives that meet the D and C requirements. I believe I have grown a lot since the midterm, and I made many revisions to my labs, including creating more professional-looking code. I also incorporated more advanced coding changes, such as improved color choices in my graphs.

Certain learning objectives that I missed from the midterm portfolio, like WD-4, were a priority for me to revise. I went back through previous labs, such as Lab 5, and made improvements, and I also made sure that my newer labs met these requirements moving forward.

I also prioritized WD-5, so I revisited Lab 5 and added examples of inner_join, right_join, and left_join, since that was where many of the joins were expected to appear. I had not completed them correctly before, so I made sure to redo that work for the final portfolio.

My only concern is with R-1 because some of my earlier labs were not formatted as professional looking documents. However, I understand how to do this now, and I can show that I have made these changes in my current files.
...
# lab 5 
drivers_license_real <- drivers_license |> 
    filter(
        hair_color == "red", 
        gender == "female", 
        car_make == "Tesla", 
...
#| label: wd-3-date
# lab 5 
# using ymd to put date in correct object, revised for portfolio 
...
I revised my thinking after the midterm by looking through my midterm rubric, editing code after given feedback, redoing labs from before the midterm in order to fill holes in my portfolio, and going to office hours. Leading up to the final portfolio I was looking through old labs specifically lab 3-5. I had many holes to fill in my learnings/portfolio after the midterm. So I made sure to start editing/revising those missing holes. I made sure to redo lab 5 because I was missing a lot of WD-5 and WD-6. So I made sure to redo the lab, and look over rubric comments in order to make critical changes. When labs were due I made sure to go to office hours and ask questions in class in order to ask clarifying questions and add essential code chunks to make my code preform better. Overall I think I grew a lot from my coding knowledge and effort from after the midterm.
...
After the midterm I extended my thinking by feeling confident to add in new colors to plots and tables. I also researched how to make tables look better using gt(). I am very proud of a column plot I have from lab 10 question 4. I added non-default colors, and had the sample sizes in the legend to change it up a little bit.
...
This is the code review I put for lab 10 for May, "Hi May! Nice work on lab 10, your code looks amazing and I love the way that you have clear labeling, and all of your functions are named. One suggestion I have is for question 3 using ggplot, to make the code less compact I would suggest adding a new line in between the parentheses and plus sign, ))+. Other than that I think your code looks great and it is very easy to follow what you are trying to do!". This comment I added I think will make May's code look great and less combat. I also mentioned that I liked how she added variable labels to the function.
